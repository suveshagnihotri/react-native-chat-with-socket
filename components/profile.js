...
export default class profile extends Component {
  constructor(props) {
    super(props);
     this.socket = SocketIOClient('http://192.168.0.3:8080');
      this.state = {
          users:[{id:1, nickname:"Loading Data..."}],
      };
  ...
  render() {
    return (
      <View>
        ...
        <Image source={require('../images/cover.jpeg')} style={styles.background} resizeMode="cover">
